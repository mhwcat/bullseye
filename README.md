...
### Windows
Use CMake (min. 3.13) to generate Visual Studio solution. You might have to manually set `SDL2_PATH`  to your local SDL2 development library path and `GLM_INCLUDE_DIR` to your local GLM installation path. SDL2.dll have to be copied to output build directory.  
Tested on Windows 10, CMake 3.19.6 and Visual Studio 2019 16.9.1.
### Linux 
Install SDL2 and GLM. For Ubuntu-based distros:
```bash
sudo apt update
